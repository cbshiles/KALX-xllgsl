...
COMPLEX_UNARY(complex_arcsin, PREFIX "COMPLEX.ARCSIN", 
...
COMPLEX_UNARY(complex_arccos, PREFIX "COMPLEX.ARCCOS", 
...
COMPLEX_UNARY(complex_arctan, PREFIX "COMPLEX.ARCTAN", 
...
COMPLEX_UNARY(complex_arcsec, PREFIX "COMPLEX.ARCSEC", 
...
COMPLEX_UNARY(complex_arccsc, PREFIX "COMPLEX.ARCCSC", 
...
COMPLEX_UNARY(complex_arccot, PREFIX "COMPLEX.ARCCOT", 
...
COMPLEX_UNARY(complex_sinh, PREFIX "COMPLEX.SINH", 
...
COMPLEX_UNARY(complex_cosh, PREFIX "COMPLEX.COSH", 
...
COMPLEX_UNARY(complex_tanh, PREFIX "COMPLEX.TANH", 
...
COMPLEX_UNARY(complex_coth, PREFIX "COMPLEX.COTH", 
...
COMPLEX_UNARY(complex_arcsinh, PREFIX "COMPLEX.ARCSINH", 
...
COMPLEX_UNARY(complex_arccosh, PREFIX "COMPLEX.ARCCOSH", 
...
COMPLEX_UNARY(complex_arctanh, PREFIX "COMPLEX.ARCTANH", 
...
COMPLEX_UNARY(complex_arcsech, PREFIX "COMPLEX.ARCSECH", 
...
COMPLEX_UNARY(complex_arccsch, PREFIX "COMPLEX.ARCCSCH", 
...
COMPLEX_UNARY(complex_arccoth, PREFIX "COMPLEX.ARCCOTH", 
...
XLL_TEST_BEGIN(complex_math)
		...
		XLL_ENSURE("{1, 0} = " PREFIX "COMPLEX.POLAR(1, 0)");
		XLL_ENSURE("{1, 0} = " PREFIX "COMPLEX.POLAR(1, 0)");
//		XLL_ENSURE("{-1, 0} = " PREFIX "COMPLEX.POLAR(1, PI())"); // fails!
		XLL_ENSURE("{4,6} = " PREFIX "COMPLEX.ADD({1,2},{3,4})");
		XLL_ENSURE("{-2,-2} = " PREFIX "COMPLEX.SUB({1,2},{3,4})");
		XLL_ENSURE("{-5,10} = " PREFIX "COMPLEX.MUL({1,2},{3,4})");
		OPERX div = EVAL(PREFIX "COMPLEX.DIV({1,2},{3,4})");
		OPERX inv = EVAL(PREFIX "COMPLEX.MUL({1,2}," PREFIX "COMPLEX.INVERSE({3,4}))");
